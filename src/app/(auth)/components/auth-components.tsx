...
export const Footer = () => {
    ...
    return (
        <div className="flex gap-4">
            ...
            <Text textColor={theme.darkColors.text.secondary}>•</Text>
            <Text textColor={theme.darkColors.text.secondary}>
                Privacy Policy
            </Text>
            <Text textColor={theme.darkColors.text.secondary}>•</Text>
...
export const SideImage = () => {
    ...
    return (
        <div className="relative flex flex-1 dark bg-bg-secondary/60 overflow-hidden rounded-xl">
            <div className="flex flex-col gap-2 pt-[30px] pl-[70px]">
                <div className="flex items-center w-fit rounded-full px-2.5 py-1.5 border border-border-tetiary gap-2">
                    ...
                    <Text textColor={theme.darkColors.text.tetiary}>Galamsey Detection System</Text>
                </div>
                <Text textColor={theme.darkColors.text.secondary} className="pl-0.5">
