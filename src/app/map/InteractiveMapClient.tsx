            ...
            <GeoJSON
              ...
              onEachFeature={(feature, leafletLayer) => {
                ...
                if (selectedDistricts.length === 0 || isSelected) {
                  // Add tooltip with district and region info
                  const tooltipContent = `${district}${feature.properties.region ? ` (${feature.properties.region})` : ''}`;
  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        ...
        />
        {/* Removed: Add drawing and print controls */}
        {/* <DynamicMapControls /> */}
        {/* Add the coordinate display component */}
