    ...
    <div className="h-full">
      <div
        className={`${isExpanded ? "w-[250px]" : "w-[54px]"
          } h-full bg-white/90 z-[1005] backdrop-blur-md border-[1px] border-border-primary rounded-2xl flex flex-col transition-all duration-500 ease-in-out relative `}
      >
